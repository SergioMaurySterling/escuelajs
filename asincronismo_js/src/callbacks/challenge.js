...
//FUNCION fetch data que nos permitira traer la info de la api y tendra un callback
function fetchData (url_api,callback){
    ...
    xhttp.onreadystatechange = function (event){
        if(xhttp.readyState === 4){
            if(xhttp.status === 200){
                callback(null, JSON.parse(xhttp.responseText))// .parse me convierte a texto el JSON
            } else {
